...
public class sentence1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer sentence = MediaPlayer.create(this, R.raw.sentence2);
    ...
    public void onButtonClick(View v){
        if(v.getId() == R.id.next){
            Intent i = new Intent(sentence1.this, sentence2.class);
            startActivity(i);
        }
    }
    ...
    public void onButtonClick(View v){
        if(v.getId() == R.id.previous){
            Intent i = new Intent(sentence1.this, MyActivity.class);
            startActivity(i);
        }
    }
