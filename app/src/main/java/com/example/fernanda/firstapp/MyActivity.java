//package com.android.audiorecordingdemo;
...
public class MyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer sentence = MediaPlayer.create(this, R.raw.sentence1);
    ...
    public void onButtonClick(View v){
        if(v.getId() == R.id.next){
            Intent i = new Intent(MyActivity.this, sentence1.class);
            startActivity(i);
        }
    }
